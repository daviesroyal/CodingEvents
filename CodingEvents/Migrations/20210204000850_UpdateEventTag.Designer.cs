...
namespace CodingEvents.Migrations
{
    ...
    [Migration("20210204000850_UpdateEventTag")]
    partial class UpdateEventTag
    {
            ...
            modelBuilder.Entity("CodingEvents.Models.EventTag", b =>
                {
                    ...
                    b.Property<int?>("EventTagEventId")
                        .HasColumnType("int");

                    b.Property<int?>("EventTagTagId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CodingEvents.Models.EventTag", b =>
                {
                    ...
                    b.HasOne("CodingEvents.Models.EventTag", null)
                        .WithMany("EventTags")
                        .HasForeignKey("EventTagEventId", "EventTagTagId");
                });
